...
public class Generator {
     ...
     */
    public static void generateAll(int degree, int quantityOfUsersInTheBtree, int quantityOfUsersWithAFlight){
        ...
        int[] users = UserFlightDataGenerator.getRandomKeys(hashMap, quantityOfUsersWithAFlight);
            ...
            //METODO PARA OBTENER TODOS LOS VUELOS DISPONIBLES (AUN NO SE CREO DICHO METODO)
